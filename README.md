...
I created a PCB with KiCad, as it was cleaner than using a prototype board and provided GERBER files for PCB Manufacturing in "Gerber".  I used JLCPCB to have the PCB built.
